using BoilerPlate.Shared.Infrastructure.Logging.Options;
using FileOptions = BoilerPlate.Shared.Infrastructure.Logging.Options.FileOptions;

namespace BoilerPlate.Shared.Infrastructure.Logging;
